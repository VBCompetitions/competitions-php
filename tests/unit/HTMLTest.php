...
final class HTMLTest extends TestCase {
    ...
    public function testHTMLMatchesForHTMLWithEverything() : void
    {
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][0]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][0]->metadata["match"]->getID());
        $this->assertEquals(HTML::MATCH_COLUMN_COURT, $matches->rows[1][1]->column_id);
        $this->assertEquals('vbc-match-court vbc-match-group-LG', $matches->rows[1][1]->class);
        $this->assertEquals('1', $matches->rows[1][1]->text);
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][1]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][1]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][2]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][2]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][3]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][3]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][4]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][4]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][5]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][5]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][6]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][6]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][7]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][7]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][8]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][8]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][9]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][9]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][10]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][10]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][11]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][11]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][12]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][12]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][13]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][13]->metadata["match"]->getID());
        ...
        $this->assertInstanceOf('VBCompetitions\Competitions\GroupMatch', $matches->rows[1][14]->metadata["match"]);
        $this->assertEquals('LG1', $matches->rows[1][14]->metadata["match"]->getID());
        ...
        $this->assertEquals(HTML::MATCH_COLUMN_WARMUP, $matches->rows[2][3]->column_id);
        $this->assertEquals('vbc-match-warmup vbc-match-played vbc-match-group-LG', $matches->rows[2][3]->class);
        $this->assertEquals('10:10', $matches->rows[2][3]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_START, $matches->rows[2][4]->column_id);
        $this->assertEquals('vbc-match-start vbc-match-played vbc-match-group-LG', $matches->rows[2][4]->class);
        $this->assertEquals('10:20', $matches->rows[2][4]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_DURATION, $matches->rows[2][5]->column_id);
        $this->assertEquals('vbc-match-duration vbc-match-group-LG', $matches->rows[2][5]->class);
        $this->assertEquals('0:20', $matches->rows[2][5]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_TEAM, $matches->rows[2][6]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[2][6]->class);
        $this->assertEquals('Team 1', $matches->rows[2][6]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_SCORE, $matches->rows[2][7]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-loser', $matches->rows[2][7]->class);
        $this->assertEquals('22', $matches->rows[2][7]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_SCORE, $matches->rows[2][8]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-winner', $matches->rows[2][8]->class);
        $this->assertEquals('24', $matches->rows[2][8]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_TEAM, $matches->rows[2][9]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[2][9]->class);
        $this->assertEquals('Team 3', $matches->rows[2][9]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_OFFICIALS, $matches->rows[2][10]->column_id);
        $this->assertEquals('vbc-match-officials vbc-match-group-LG', $matches->rows[2][10]->class);
        $this->assertEquals('Team 2', $matches->rows[2][10]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MVP, $matches->rows[2][11]->column_id);
        $this->assertEquals('vbc-match-mvp vbc-match-group-LG', $matches->rows[2][11]->class);
        $this->assertEquals('B Betts', $matches->rows[2][11]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MANAGER, $matches->rows[2][12]->column_id);
        $this->assertEquals('vbc-match-manager vbc-match-group-LG', $matches->rows[2][12]->class);
        $this->assertEquals('Team 2', $matches->rows[2][12]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_NOTES, $matches->rows[2][13]->column_id);
        $this->assertEquals('vbc-match-notes vbc-match-group-LG', $matches->rows[2][13]->class);
        $this->assertEquals('some notes', $matches->rows[2][13]->text);
        ...
        $this->assertEquals(HTML::MATCH_COLUMN_WARMUP, $matches->rows[3][3]->column_id);
        $this->assertEquals('vbc-match-warmup vbc-match-played vbc-match-group-LG', $matches->rows[3][3]->class);
        $this->assertEquals('11:10', $matches->rows[3][3]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_START, $matches->rows[3][4]->column_id);
        $this->assertEquals('vbc-match-start vbc-match-played vbc-match-group-LG', $matches->rows[3][4]->class);
        $this->assertEquals('11:20', $matches->rows[3][4]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_DURATION, $matches->rows[3][5]->column_id);
        $this->assertEquals('vbc-match-duration vbc-match-group-LG', $matches->rows[3][5]->class);
        $this->assertEquals('0:20', $matches->rows[3][5]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_TEAM, $matches->rows[3][6]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[3][6]->class);
        $this->assertEquals('Team 2', $matches->rows[3][6]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_SCORE, $matches->rows[3][7]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-loser', $matches->rows[3][7]->class);
        $this->assertEquals('23', $matches->rows[3][7]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_SCORE, $matches->rows[3][8]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-winner', $matches->rows[3][8]->class);
        $this->assertEquals('26', $matches->rows[3][8]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_TEAM, $matches->rows[3][9]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[3][9]->class);
        $this->assertEquals('Team 3', $matches->rows[3][9]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_OFFICIALS, $matches->rows[3][10]->column_id);
        $this->assertEquals('vbc-match-officials vbc-match-group-LG', $matches->rows[3][10]->class);
        $this->assertEquals('Team 4', $matches->rows[3][10]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MVP, $matches->rows[3][11]->column_id);
        $this->assertEquals('vbc-match-mvp vbc-match-group-LG', $matches->rows[3][11]->class);
        $this->assertEquals('C Crosier', $matches->rows[3][11]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MANAGER, $matches->rows[3][12]->column_id);
        $this->assertEquals('vbc-match-manager vbc-match-group-LG', $matches->rows[3][12]->class);
        $this->assertEquals('Team 4', $matches->rows[3][12]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_NOTES, $matches->rows[3][13]->column_id);
        $this->assertEquals('vbc-match-notes vbc-match-group-LG', $matches->rows[3][13]->class);
        $this->assertEquals('some notes', $matches->rows[3][13]->text);
        ...
        $this->assertEquals(HTML::MATCH_COLUMN_WARMUP, $matches->rows[8][3]->column_id);
        $this->assertEquals('vbc-match-warmup vbc-match-played vbc-match-group-LG', $matches->rows[8][3]->class);
        $this->assertEquals('14:10', $matches->rows[8][3]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_START, $matches->rows[8][4]->column_id);
        $this->assertEquals('vbc-match-start vbc-match-played vbc-match-group-LG', $matches->rows[8][4]->class);
        $this->assertEquals('14:20', $matches->rows[8][4]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_DURATION, $matches->rows[8][5]->column_id);
        $this->assertEquals('vbc-match-duration vbc-match-group-LG', $matches->rows[8][5]->class);
        $this->assertEquals('0:20', $matches->rows[8][5]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_TEAM, $matches->rows[8][6]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[8][6]->class);
        $this->assertEquals('Team 3', $matches->rows[8][6]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_SCORE, $matches->rows[8][7]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-loser', $matches->rows[8][7]->class);
        $this->assertEquals('25', $matches->rows[8][7]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_SCORE, $matches->rows[8][8]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-winner', $matches->rows[8][8]->class);
        $this->assertEquals('30', $matches->rows[8][8]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_TEAM, $matches->rows[8][9]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[8][9]->class);
        $this->assertEquals('Team 4', $matches->rows[8][9]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_OFFICIALS, $matches->rows[8][10]->column_id);
        $this->assertEquals('vbc-match-officials vbc-match-group-LG', $matches->rows[8][10]->class);
        $this->assertEquals('Team 2', $matches->rows[8][10]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MVP, $matches->rows[8][11]->column_id);
        $this->assertEquals('vbc-match-mvp vbc-match-group-LG', $matches->rows[8][11]->class);
        $this->assertEquals('E Edwards', $matches->rows[8][11]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MANAGER, $matches->rows[8][12]->column_id);
        $this->assertEquals('vbc-match-manager vbc-match-group-LG', $matches->rows[8][12]->class);
        $this->assertEquals('Team 2', $matches->rows[8][12]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_NOTES, $matches->rows[8][13]->column_id);
        $this->assertEquals('vbc-match-notes vbc-match-group-LG', $matches->rows[8][13]->class);
        $this->assertEquals('some notes', $matches->rows[8][13]->text);
        ...
        $this->assertEquals(HTML::MATCH_COLUMN_WARMUP, $matches->rows[9][3]->column_id);
        $this->assertEquals('vbc-match-warmup vbc-match-played vbc-match-group-LG', $matches->rows[9][3]->class);
        $this->assertEquals('15:10', $matches->rows[9][3]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_START, $matches->rows[9][4]->column_id);
        $this->assertEquals('vbc-match-start vbc-match-played vbc-match-group-LG', $matches->rows[9][4]->class);
        $this->assertEquals('15:20', $matches->rows[9][4]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_DURATION, $matches->rows[9][5]->column_id);
        $this->assertEquals('vbc-match-duration vbc-match-group-LG', $matches->rows[9][5]->class);
        $this->assertEquals('0:20', $matches->rows[9][5]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_TEAM, $matches->rows[9][6]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[9][6]->class);
        $this->assertEquals('Team 1', $matches->rows[9][6]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_HOME_SCORE, $matches->rows[9][7]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-loser', $matches->rows[9][7]->class);
        $this->assertEquals('26', $matches->rows[9][7]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_SCORE, $matches->rows[9][8]->column_id);
        $this->assertEquals('vbc-match-score vbc-match-group-LG vbc-match-winner', $matches->rows[9][8]->class);
        $this->assertEquals('32', $matches->rows[9][8]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_AWAY_TEAM, $matches->rows[9][9]->column_id);
        $this->assertEquals('vbc-match-team vbc-match-group-LG', $matches->rows[9][9]->class);
        $this->assertEquals('Team 2', $matches->rows[9][9]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_OFFICIALS, $matches->rows[9][10]->column_id);
        $this->assertEquals('vbc-match-officials vbc-match-group-LG', $matches->rows[9][10]->class);
        $this->assertEquals('Team 4', $matches->rows[9][10]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MVP, $matches->rows[9][11]->column_id);
        $this->assertEquals('vbc-match-mvp vbc-match-group-LG', $matches->rows[9][11]->class);
        $this->assertEquals('F Franks', $matches->rows[9][11]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_MANAGER, $matches->rows[9][12]->column_id);
        $this->assertEquals('vbc-match-manager vbc-match-group-LG', $matches->rows[9][12]->class);
        $this->assertEquals('Joe Bloggs', $matches->rows[9][12]->text);
        $this->assertEquals(HTML::MATCH_COLUMN_NOTES, $matches->rows[9][13]->column_id);
        $this->assertEquals('vbc-match-notes vbc-match-group-LG', $matches->rows[9][13]->class);
        $this->assertEquals('some notes', $matches->rows[9][13]->text);
    }
