...
final class HTMLTest extends TestCase {
    public function testHTMLMatchesForHTMLPlain() : void
    {
        ...
        $this->assertEquals('Team 3', $matches->rows[4][8]->text);
    ...
    public function testHTMLMatchesForHTMLWithEverything() : void
    {
        ...
        $this->assertEquals('Team 4', $matches->rows[9][13]->text);
    ...
    public function testHTMLMatchesHTMLEverything() : void
    {
        ...
        $expected_table .= '<tr><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td><td class="">&nbsp;</td></tr>';
        $expected_table .= '<tr><td class="vbc-match-id vbc-match-group-LG">LG4</td><td class="vbc-match-court vbc-match-group-LG">1</td><td class="vbc-match-venue vbc-match-group-LG">City Sports Centre</td><td class="vbc-match-date vbc-match-played vbc-match-group-LG" rowspan="3">2023-06-21</td><td class="vbc-match-warmup vbc-match-played vbc-match-group-LG">13:10</td><td class="vbc-match-start vbc-match-played vbc-match-group-LG">13:20</td><td class="vbc-match-duration vbc-match-group-LG">0:20</td><td class="vbc-match-team vbc-match-group-LG">Team 1</td><td class="vbc-match-score vbc-match-group-LG vbc-match-loser">24</td><td class="vbc-match-score vbc-match-group-LG vbc-match-winner">28</td><td class="vbc-match-team vbc-match-group-LG">Team 4</td><td class="vbc-match-officials vbc-match-group-LG">Team 3</td><td class="vbc-match-mvp vbc-match-group-LG">D Dodds</td><td class="vbc-match-manager vbc-match-group-LG">Team 3</td><td class="vbc-match-notes vbc-match-group-LG">some notes</td></tr>';
        ...
        $expected_table .= '<tr><td class="vbc-match-id vbc-match-group-LG">LG6</td><td class="vbc-match-court vbc-match-group-LG">1</td><td class="vbc-match-venue vbc-match-group-LG">City Sports Centre</td><td class="vbc-match-warmup vbc-match-played vbc-match-group-LG">15:10</td><td class="vbc-match-start vbc-match-played vbc-match-group-LG">15:20</td><td class="vbc-match-duration vbc-match-group-LG">0:20</td><td class="vbc-match-team vbc-match-group-LG">Team 1</td><td class="vbc-match-score vbc-match-group-LG vbc-match-loser">26</td><td class="vbc-match-score vbc-match-group-LG vbc-match-winner">32</td><td class="vbc-match-team vbc-match-group-LG">Team 2</td><td class="vbc-match-officials vbc-match-group-LG">Team 4</td><td class="vbc-match-mvp vbc-match-group-LG">F Franks</td><td class="vbc-match-manager vbc-match-group-LG">Team 4</td><td class="vbc-match-notes vbc-match-group-LG">some notes</td></tr>';
        $expected_table .= '</table>';
    ...
    public function testHTMLMatchesHTMLOtherConfig() : void
    {
        ...
        $expected_matches .= '<tr><td class="vbc-match-id vbc-match-group-LG">LG6</td><td class="vbc-match-blank vbc-match-group-LG"></td><td class="vbc-match-team vbc-match-group-LG vbc-this-team">TM1</td><td class="vbc-match-team vbc-match-group-LG">TM2</td><td class="vbc-match-officials vbc-match-group-LG">TM4</td><td class="vbc-match-manager vbc-match-group-LG">TM4</td></tr>';
        $expected_matches .= '</table>';
